...
class ControllerOctemplatesSreviewSetting extends Controller {
    ...
    $this->load->model('octemplates/sreview_setting');
		...
		if (!in_array('oct_sreview_setting', $this->model_extension_extension->getInstalled('module'))) {
      ...
      $this->model_extension_extension->install('module', 'oct_sreview_setting');
    }
  ...
  public function uninstall() {
  	$this->load->language('octemplates/sreview_setting');
		...
		$this->model_extension_extension->uninstall('module', 'oct_sreview_setting');
