...
class ModelModulePopupCallPhone extends Model {
	public function getCall($request_id) {
		$query = $this->db->query("SELECT DISTINCT * FROM `".DB_PREFIX."popup_call_phone` WHERE request_id = '".(int)$request_id."'");

		return $query->row;
	}

	public function deleteCall($request_id) {
		$this->db->query("DELETE FROM `".DB_PREFIX."popup_call_phone` WHERE request_id = '".(int)$request_id."'");
	}

	public function deleteAllCallArray() {
		$this->db->query("DELETE FROM `".DB_PREFIX."popup_call_phone`");
	}

	public function getCallArray($data = array()) {
		$sql = "SELECT * FROM `".DB_PREFIX."popup_call_phone` ";
	...
	public function getTotalCallArray() {
		$sql = "SELECT COUNT(*) AS total FROM `".DB_PREFIX."popup_call_phone`";
	...
	public function makeDB() {
		$sql  = "CREATE TABLE IF NOT EXISTS `".DB_PREFIX."popup_call_phone` ( ";
	...
	public function deleteDB() {
		$this->db->query("DROP TABLE IF EXISTS `".DB_PREFIX."popup_call_phone`;");
	}
}