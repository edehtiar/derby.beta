<?php
class ModelEditorsInformation extends Model {
	public function addInformation($data) {
		...
		if (isset($this->request->post['auto_keyword_information'])) {
			...
			if ($data['keyword']) {
				...
				if ($informationTitle) {
					$this->model_tool_seo_manager->generateInformation($information_id, $informationTitle, $this->config->get('maxy_seo_informations_template_url_alias'), $this->config->get('config_language'));
				}
			}
		} else {
			if ($data['keyword']) {
	...
	public function editInformation($information_id, $data) {
		...
		if ($this->request->post['auto_keyword_information']) {
