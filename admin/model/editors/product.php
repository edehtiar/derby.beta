<?php
class ModelEditorsProduct extends Model {
	public function addProduct($data) {
		...
		if (isset($this->request->post['auto_keyword_product'])) {
			if ($data['keyword']) {
				...
				if ($productName) {
					$this->model_tool_seo_manager->generateProduct($product_id, $productName, $data['model'], $manufacturerName, $this->config->get('maxy_seo_products_template_url_alias'), $this->config->get('config_language'));
				}
			}
		} else {
			if ($data['keyword']) {
