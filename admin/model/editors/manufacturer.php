<?php
class ModelEditorsManufacturer extends Model {
	public function addManufacturer($data) {
		...
		if (isset($this->request->post['auto_keyword_manufacturer'])) {
			if ($data['keyword']) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "url_alias SET query = 'manufacturer_id=" . (int)$manufacturer_id . "', keyword = '" . $this->db->escape($data['keyword']) . "'");
			} else {
				$this->load->model('tool/seo_manager');
				$this->model_tool_seo_manager->generateManufacturer($manufacturer_id, $this->config->get('maxy_seo_manufacturers_template_url_alias'), $this->config->get('config_language'));
			}
		} else {
			if ($data['keyword']) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "url_alias SET query = 'manufacturer_id=" . (int)$manufacturer_id . "', keyword = '" . $this->db->escape($data['keyword']) . "'");
	...
	public function editManufacturer($manufacturer_id, $data) {
		...
		if ($this->request->post['auto_keyword_manufacturer']) {
			if ($data['keyword']) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "url_alias SET query = 'manufacturer_id=" . (int)$manufacturer_id . "', keyword = '" . $this->db->escape($data['keyword']) . "'");
			} else {
				$this->load->model('tool/seo_manager');
