	...
	public function deleteSubject($oct_sreview_subject_id) {
		...
		if ($reviews) {
			foreach ($reviews as $review) {
				$this->db->query("UPDATE " . DB_PREFIX . "oct_sreview_subject SET subject_rating_count" . (int)$review['rating'] . " = (subject_rating_count" . (int)$review['rating'] . " - " . (int)$review['rating'] . ") WHERE oct_sreview_subject_id = '" . (int)$oct_sreview_subject_id . "'");
			}
