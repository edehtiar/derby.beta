  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-information" input type="hidden" name="apply" value="1" data-toggle="tooltip" title="<?php echo $button_apply; ?>" class="btn btn-success"><i class="fa fa-check"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
       <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $text_form; ?><span class="information_name"></span></h3>
      </div>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="auto_keyword_information" class="form-control" id="auto-keyword-information">
			  ...
			  <div class="form-group hide">
				...
				<div class="col-sm-10">
				  <select name="auto_keyword_information" class="form-control">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="input-checkbox">
				    <?php if ($bottom) { ?>
                      <input type="checkbox" class="checkbox" name="bottom" value="1" checked="checked" id="input-bottom" />
					  <label for="input-bottom"></label>
                      <?php } else { ?>
                      <input type="checkbox" class="checkbox" name="bottom" value="1" id="input-bottom" />
					  <label for="input-bottom"></label>
                    <?php } ?>				  
				  </div>
                </div>
...
//--></script> 
  <script type="text/javascript"><!--
$information_name = $('input[name="information_description[<?php echo $config_language_id; ?>][title]"]'); 
$title = $('.information_name');

if ($information_name.val() != '') {
	$title.html(' - ' + $information_name.val()); 
}
$information_name.keyup(function() {
	if ($information_name.val() != '') {
		$title.html(' - ' + $information_name.val()); 
	} else {
		$title.html('');
...
$(document).ready(function() {
	...
	var selectAutoSeo = $('#auto-keyword-information');
