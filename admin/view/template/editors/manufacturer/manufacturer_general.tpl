...
$(".button-save").on('click', function(){		
	<?php foreach ($languages as $language) { ?>
	var content = $('textarea[name="manufacturer_description[<?php echo $language['language_id']; ?>][description]"]').html($('#input-description<?php echo $language['language_id']; ?>').code());
	<?php } ?>	
	$.ajax({
