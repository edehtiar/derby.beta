  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-mass-product-meta-title" class="form-horizontal">	
	...
	<div class="form-group required" id="meta-title-custom">	
	  <?php foreach ($languages as $language) { ?>
		...
		<div class="col-sm-10">
		  <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span><input type="text" name="product_description[<?php echo $language['language_id']; ?>][meta_title]" value="" placeholder="<?php echo $entry_meta_title; ?>" class="form-control" /></div><br />
		</div>
	  <?php } ?>
	</div>
