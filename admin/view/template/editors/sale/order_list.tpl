            ...
            <table class="table table-bordered table-hover">
              <thead>
				...
				<tr>
                  ...
                  <td class="text-center" style="width: 130px; min-width: 130px;"><?php echo $column_action; ?></td>
                </tr>
              </thead>
              <tbody>
                <?php if ($orders) { ?>
                ...
                <tr>
                  ...
                  <td class="text-center">
				    <a href="<?php echo $order['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-warning btn-sm"><i class="fa fa-star-o fa-fw"></i></a>
                    ...
                    <button type="button" value="<?php echo $order['order_id']; ?>" id="button-delete<?php echo $order['order_id']; ?>" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash-o fa-fw"></i></button>
				  </td>
                </tr>
                <?php } ?>
                <?php } else { ?>
