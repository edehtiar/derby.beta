  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-category" input type="hidden" name="apply" value="1" data-toggle="tooltip" title="<?php echo $button_apply; ?>" class="btn btn-success"><i class="fa fa-check"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $text_form; ?><span class="category_name"></span></h3>
      </div>
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="category-filter" class="well well-sm maxy-scrollbox" style="height: 160px; overflow: auto;">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <select name="auto_keyword_category" class="form-control" id="auto-keyword-category">
			  ...
			  <div class="form-group hide">
				...
				<div class="col-sm-10">
				  <select name="auto_keyword_category" class="form-control">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="input-checkbox">
				    <?php if ($top) { ?>
                      <input type="checkbox" class="checkbox" name="top" value="1" checked="checked" id="input-top" />
					  <label for="input-top"></label>
                      <?php } else { ?>
                      <input type="checkbox" class="checkbox" name="top" value="1" id="input-top" />
					  <label for="input-top"></label>
                    <?php } ?>				  
				  </div>
                </div>
...
//--></script>
  <script type="text/javascript"><!--
$category_name = $('input[name="category_description[<?php echo $config_language_id; ?>][name]"]'); 
$title = $('.category_name');
...
$(document).ready(function() {
	...
	var selectAutoSeo = $('#auto-keyword-category');
