            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <?php if ($option_name) { ?>
				    <td class="text-left"><a onclick="getName('<?php echo $option['option_id']; ?>');" data-toggle="popover-maxy" data-target="#option-name-<?php echo $option['option_id']; ?>" data-placement="top top-left" id="option-name<?php echo $option['option_id']; ?>" class="btn-hover-list"><?php echo $option['name']; ?></a></td>
				    <?php } else { ?>
				    <td class="text-left"><?php echo $option['name']; ?></td>
				  <?php } ?>
                  <?php if ($option_sort_order) { ?>
				    <td class="text-right"><a data-toggle="popover-maxy" data-target="#option-sort-<?php echo $option['option_id']; ?>" data-placement="top top-right" id="option-sort<?php echo $option['option_id']; ?>" class="btn btn-default btn-sm"><?php echo $option['sort_order']; ?></a></td>
                    <?php } else { ?>
...
<?php foreach ($options as $option) { ?>
  <div id="option-name-<?php echo $option['option_id']; ?>" class="popover popover-md popover-primary animated-fast zoomIn" style="height: 198px !important;">
    <div class="arrow"></div>
  ...
  <div id="option-sort-<?php echo $option['option_id']; ?>" class="popover popover-primary animated-fast zoomIn">
    ...
    <div class="popover-content">
      <form class="form-vertical">
	    <div class="row">
          <div class="col-sm-12">
            <input type="text" name="sort_order" value="<?php echo $option['sort_order']; ?>" placeholder="<?php echo $column_sort_order; ?>" id="input-sort<?php echo $option['option_id']; ?>" class="form-control" />
          </div>
	    </div>
      </form>
    </div>
