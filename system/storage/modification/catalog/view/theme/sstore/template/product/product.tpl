...
<div id="container">
  <div class="row">
	...
	<?php } else { ?>
		<li><span itemprop="name"><?php echo $breadcrumb['text']; ?></span></li>
	<?php } ?>
        <?php } ?>
    </ul>
    </div>
  <div class="content">
    ...
    <article id="content" class="<?php echo $class; ?>">
      ...
      <?php } ?>
              ...
              <?php $rating_data = preg_replace("/[^0-9]/", '', $reviews); ?>
                ...
                <div class="review" <?php if($storeset_microdata !='' && $rating_data>0) { ?>itemprop="aggregateRating" itemscope="" itemtype="http://schema.org/AggregateRating"<?php } ?>>
                    ...
                    <?php if($manufacturer_infos['image']) { ?>    
                       <a href="<?php echo $manufacturers; ?>"><img src="image/<?php echo $manufacturer_infos['image']; ?>" class="manufacturer-logo"></a>
            ...
            if (!$special) {
				  $microprice = preg_replace("/[\D].[\D]/", '', rtrim($price, "."));
		           } else { 
		          $microprice = preg_replace("/[\D].[\D]/", '', rtrim($special, "."));
		          } 
             } ?>
            ...
            <?php if ($price) { ?>
              ...
              <?php if($storeset_microdata !='') { ?><meta itemprop="priceCurrency" content="<?php echo $currency_code_data; ?>" /><? } ?>
                <?php if (!$special) { ?>
                <span class="micro-price" <?php if($storeset_microdata !='') { ?>itemprop="price"<?php } ?>><?php echo str_replace(" ", "", $microprice);  ?></span>
                
      <?php if (isset($images_by_options_data['status']) && $images_by_options_data['status']) { ?>
        <span class="price-new" id="update_price"><?php echo $price; ?></span>
      <?php } else { ?>
      ...
      <?php if (isset($images_by_options_data['status']) && $images_by_options_data['status']) { ?>
        <span class="price-new" id="update_special"><?php echo $special; ?></span>
      <?php } else { ?>
        <span class="price-new"><?php echo $special; ?></span>
      <?php } ?>
      <br />
      <?php if (isset($images_by_options_data['status']) && $images_by_options_data['status']) { ?>
        <span class="price-old" id="update_price"><?php echo $price; ?></span>
      <?php } else { ?>
      ...
      <?php if (isset($images_by_options_data['status']) && $images_by_options_data['status']) { ?>
        <select onchange="update_prices_opt();" name="option[<?php echo $option['product_option_id']; ?>]" id="input-option<?php echo $option['product_option_id']; ?>" class="form-control">
      <?php } else { ?>
      ...
      <?php if (isset($images_by_options_data['status']) && $images_by_options_data['status']) { ?>
        <input onchange="update_prices_opt();" type="checkbox" name="option[<?php echo $option['product_option_id']; ?>][]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>" />
      <?php } else { ?>
      ...
      <?php if (isset($images_by_options_data['status']) && $images_by_options_data['status']) { ?>
        <div class="number">
          ...
          <input type="text" name="quantity" value="<?php echo $minimum; ?>" maxlength="4" class="plus-minus" onchange="update_prices_opt(); return validate(this);" onkeyup="update_prices_opt(); return validate(this);">
        </div>
      <?php } else { ?>
        <div class="number">
          <input name="product_id" value="<?php echo $product_id; ?>" style="display: none;" type="hidden">
          <div class="frame-change-count">
            <div class="btn-plus">
              <button type="button" id="superplus" onclick="update_prices_opt('50');" class="main-color1">
                <span class="icon-plus"><i class="fa fa-plus"></i></span>
              </button>
            </div>
            <div class="btn-minus">
              <button type="button" id="superminus" onclick="update_prices_opt('50');" class="main-color1">
                <span class="icon-minus"><i class="fa fa-minus"></i></span>
              </button>
            </div>
          </div>
          <input type="text" name="quantity" value="1" maxlength="4" class="plus-minus" onchange="update_prices_opt( '50' ); return validate(this);" onkeyup="update_prices_opt( '50' ); return validate(this);">
        </div>
      <?php } ?>
        ...
        <div class="btn-group">
				...
				<?php } else { ?>
					<a class="button" style="background-color: #8a8a8a!important"><?php echo $stockbutton; ?></a>
					<style>
					.price {
						display: none;
					}
       ...
       <?php if ( isset($popup_purchase_data['status']) && $popup_purchase_data['status'] && $disable_buy == 0) { ?>
          ...
          $(document).on('change', '.options input[type=\'radio\'], .options input[type=\'checkbox\'], .options select', function() {
            ...
            $.ajax({
              ...
              success: function(json) {
                ...
                <?php 
                $check_zoom = isset($images_by_options_data['allow_zoom']) ? $images_by_options_data['allow_zoom']: '0';
                if ($check_zoom) { ?>  
                 if ($(window).width() > 700) {
