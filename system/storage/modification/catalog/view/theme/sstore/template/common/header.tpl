...
<script type="text/javascript" src="catalog/view/theme/sstore/js/autosearch.js"></script>
      ...
      <?php } ?>
      <?php if ( isset($popup_subscribe_form_data) && $popup_subscribe_form_data['status'] != 0) { ?>
        ...
        <script type="text/javascript">
          $(function() {
          <?php $expire = $popup_subscribe_form_data['expire'] ? $popup_subscribe_form_data['expire'] : '1';
          $expire_ms = isset($popup_subscribe_form_data['seconds']) ? $popup_subscribe_form_data['seconds'] : '10000'; ?>
          <?php setcookie('popup_subscribe', 1, time() + (60*60*24*$expire), "/"); ?>
          var expire_timer = "<?php echo $expire_ms; ?>";
          var expire_timeout = setTimeout(function(){
          get_popup_subscribe();
          }, expire_timer);
          <?php if ( isset( $_COOKIE['popup_subscribe'] ) ) { ?>
        ...
        <?php if (isset($popup_call_phone_data['status']) && $popup_call_phone_data['status']) { ?>
    ...
    <div class="top-panel">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-hidden col-md-3 top-panel-div">
                    <div class="header_logo">
                        <img src="<?php echo $logo; ?>" class="img-responsive" style="max-height:40px" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" />
                    </div>
                </div>
                <?php } else { ?>
                <div class="col-sm-hidden col-md-3 top-panel-div">
                    <div class="header_logo">
                        <a href="<?php echo $home; ?>"><img class="img-responsive" style="max-height:40px" src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" /></a>
                    </div>
                </div>
                <?php } ?>
                <?php } ?>
                ...
                <div class="col-sm-4 col-md-3 top-panel-div">
                    <div class="left">
                    <?php echo $language; ?>
                    </div>
                    <div class="right">
