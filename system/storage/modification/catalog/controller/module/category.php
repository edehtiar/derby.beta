...
class ControllerModuleCategory extends Controller {
	      ...
	      public function index() {
			...
			$result_all_categories = $this->cache->get('module_category.' . (int)$this->config->get('config_language_id') . '.' . (int)$this->config->get('config_store_id') . '.' . $this->config->get('config_customer_group_id'));
...
if (!$result_all_categories) {
			...
			$this->cache->set('module_category.' . (int)$this->config->get('config_language_id') . '.' . (int)$this->config->get('config_store_id') . '.' . $this->config->get('config_customer_group_id'), $result_all_categories);
}
