  ...
  <ul class="nav pull-right">
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><span class="label label-danger pull-left"><?php echo $alerts; ?></span> <i class="fa fa-bell fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right alerts-dropdown">
        ...
        <?php if (isset($popup_found_cheaper['status']) && $popup_found_cheaper['status']) { ?>
        <li class="dropdown-header"><?php echo $text_popup_found_cheaper; ?></li>
        <li><a href="<?php echo $popup_found_cheaper_url; ?>" style="display: block; overflow: auto;"><span class="label label-warning pull-right"><?php echo $total_popup_found_cheaper; ?></span><?php echo $text_total_popup_found_cheaper; ?></a></li>
        <li class="divider"></li>
        <?php } ?>
