<ul id="menu">
  ...
  <li><a href="<?php echo $sstore_link; ?>"><i class="fa fa-shield fa-fw"></i> <span><?php echo $text_sstore; ?></span></a></li>
  <li><a href="<?php echo $megamenu_link; ?>"><i class="fa fa-align-justify fa-fw"></i><span><?php echo $text_megamenu; ?></a></span></li>


				  <?php if ($module_installed) { ?>
				  <li id="quick-edit"><a class="parent"><i class="fa fa-pencil fa-fw"></i> <span><?php echo $text_quick_menu; ?></span></a>
					<ul>
					  <li><a href="<?php echo $category_manager; ?>"><?php echo $text_category; ?></a></li>
					  <li><a href="<?php echo $product_manager; ?>"><?php echo $text_product; ?></a></li>
					  <li><a href="<?php echo $filter_manager; ?>"><?php echo $text_filter; ?></a></li>
					  <li><a class="parent"><?php echo $text_attribute; ?></a>
						<ul>
						  <li><a href="<?php echo $attribute_manager; ?>"><?php echo $text_attribute; ?></a></li>
						  <li><a href="<?php echo $attribute_group_manager; ?>"><?php echo $text_attribute_group; ?></a></li>
						</ul>
					  </li>
					  <li><a href="<?php echo $option_manager; ?>"><?php echo $text_option; ?></a></li>
					  <li><a href="<?php echo $manufacturer_manager; ?>"><?php echo $text_manufacturer; ?></a></li>
					  <li><a href="<?php echo $review_manager; ?>"><?php echo $text_review; ?></a></li>
					  <li><a href="<?php echo $information_manager; ?>"><?php echo $text_information; ?></a></li>
					  <li><a href="<?php echo $customer_manager; ?>"><?php echo $text_customer; ?></a></li>
					  <li><a href="<?php echo $order_manager; ?>"><?php echo $text_order; ?></a></li>
					  <li><a href="<?php echo $seo_manager; ?>"><?php echo $text_seo_manager; ?></a></li>
					  <li><a href="<?php echo $setting_manager; ?>"><?php echo $text_setting; ?></a></li>
					</ul>
				  </li>
				  <?php } ?>
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    ...
    <li><a href="<?php echo $ocfilter; ?>"><?php echo $text_ocfilter; ?></a></li>
      ...
      <li><a href="<?php echo $information; ?>"><?php echo $text_information; ?></a></li>
        ...
        <li id="sreview"><a class="parent"><span><?php echo $text_oct_sreview; ?></span></a>
          <ul>
            <li><a href="<?php echo $oct_sreview_setting; ?>"><?php echo $text_oct_sreview_setting; ?></a></li>
            <li><a href="<?php echo $oct_sreview_subject; ?>"><?php echo $text_oct_sreview_subject; ?></a></li>
            <li><a href="<?php echo $oct_sreview_reviews; ?>"><?php echo $text_oct_sreview_reviews; ?></a></li>
          </ul>
        </li>
      

        <li id="blog"><a class="parent"><span><?php echo $text_blog; ?></span></a>
          <ul>
            <li><a href="<?php echo $blog_setting; ?>"><?php echo $text_blog_setting; ?></a></li>
            <li><a href="<?php echo $blog_list; ?>"><?php echo $text_blog_list; ?></a></li>
          </ul>
        </li>
      

        <?php if (isset($product_tabs_data['status']) && $product_tabs_data['status']) { ?>
        <li id="product_tabs"><a class="parent"><span><?php echo $text_product_tabs; ?></span></a>
          <ul>
            <li><a href="<?php echo $product_tabs_list; ?>"><?php echo $text_product_tabs_list; ?></a></li>
          </ul>
        </li>
        <?php } ?>
        ...
        <li id="product_stickers"><a class="parent"><span><?php echo $text_product_stickers; ?></span></a>
          <ul>
            <li><a href="<?php echo $product_stickers_list; ?>"><?php echo $text_product_stickers_list; ?></a></li>
          </ul>
        </li>
        <?php } ?>
  ...
  <li id="design"><a class="parent"><i class="fa fa-television fa-fw"></i> <span><?php echo $text_design; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $banner; ?>"><?php echo $text_banner; ?></a></li>
        ...
        <li><a href="<?php echo $banner_plus; ?>"><?php echo $text_banner_plus; ?></a></li>
