        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <div class="well well-sm" style="height: 150px; overflow: auto;">
              <?php $row = 0; foreach ($product_stickers as $product_sticker) { ?>
              <div class="checkbox">
                <label>
                  <input type="checkbox" name="product_stickers[<?php echo $row; ?>]" value="<?php echo $product_sticker['product_sticker_id']; ?>" <?php echo (!empty($product_sticker_id[$row])) ? 'checked' : ''; ?> 
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab-extra_tabs<?php echo $extra_tab_row; ?>">
                ...
                <ul class="nav nav-tabs" id="extra_tab_description_div<?php echo $extra_tab_row; ?>">
                  <?php foreach ($languages as $language) { ?>
                  <li><a href="#extra_tab_description<?php echo $extra_tab_row; ?><?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                  <?php } ?>
                </ul>
                <div class="tab-content">
                  <?php foreach ($languages as $language) { ?>
              ...
              'select': function(item) {
                html  = '<div class="tab-pane" id="tab-extra_tabs'+extra_tab_row+'">';
                  ...
                  html  += '<ul class="nav nav-tabs" id="extra_tab_description_div'+extra_tab_row+'">';
                    <?php foreach ($languages as $language) { ?>
                    html  += '<li><a href="#extra_tab_description'+extra_tab_row+'<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>';
                    <?php } ?>
                  html  += '</ul>';
          ...
          <td class="text-right">
            <?php asort($product_options); foreach ($product_options as $product_option) { ?>
              <div class="col-sm-6 col-md-6 col-lg-4">
                ...
                <?php if ($product_option['type'] == 'radio' || $product_option['type'] == 'checkbox' || $product_option['type'] == 'select' || $product_option['type'] == 'image') { ?>
                  <?php if (isset($option_values[$product_option['option_id']])) { ?>
                    <?php foreach ($option_values[$product_option['option_id']] as $option_value) { ?>  
                      <label>
