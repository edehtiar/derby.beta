...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="
    				pull-right"><?php if (isset($novaposhta_ei)) { ?><a href="<?php echo $novaposhta_ei; ?>" data-toggle="tooltip" title="<?php echo $button_ei; ?>" class="btn btn-<?php echo ($novaposhta_ei_ref) ? 'primary' : 'danger' ?>" target="_blank"><i class="fa fa-header"></i></a> <?php } ?>
