          ...
          <div class="table-responsive">
			...
			<tr style="background:#<?php echo $order['bg_color']; ?>; color:#<?php echo $order['txt_color']; ?>;">
                  ...
                  <td class="text-right"><a href="<?php echo $order['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-info"><i class="fa fa-eye"></i></a> 
    				<?php if (stristr($order['shipping_code'], '.', true) == 'novaposhta') { ?>
    				<a href="<?php echo $order['novaposhta_ei']; ?>" data-toggle="tooltip" title="<?php echo ($order['novaposhta_ei_ref']) ? $button_edit_ei : $button_create_ei ?>" class="btn btn-<?php echo ($order['novaposhta_ei_ref']) ? 'primary' : 'danger' ?>"><i class="fa fa-header"></i></a>
    				<?php } ?>
    				 <a href="<?php echo $order['edit']; ?>"
    			 data-toggle="tooltip" title="<?php echo $button_edit; ?>" id="button-edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
