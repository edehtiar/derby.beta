...
class ControllerCommonMenu extends Controller {
				...
				public function ModuleInstalled() {
					$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "extension WHERE code = 'admin_quick_edit'");
    ...
    $data['reward_customer'] = $this->url->link('sale/reward_customer_sv', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['text_oct_sreview_reviews'] = $this->language->get('text_oct_sreview_reviews');
        $data['text_oct_sreview_setting'] = $this->language->get('text_oct_sreview_setting');
        $data['oct_sreview_subject'] = $this->url->link('octemplates/sreview_subject', 'token=' . $this->session->data['token'], 'SSL');
        $data['oct_sreview_reviews'] = $this->url->link('octemplates/sreview_reviews', 'token=' . $this->session->data['token'], 'SSL');
        $data['oct_sreview_setting'] = $this->url->link('octemplates/sreview_setting', 'token=' . $this->session->data['token'], 'SSL');
      

        $data['text_banner_plus'] = $this->language->get('text_banner_plus');
        $data['banner_plus'] = $this->url->link( 'design/banner_plus', 'token=' . $this->session->data['token'], 'SSL' );
      

        $data['text_blog'] = $this->language->get('text_blog');
        $data['text_blog_list'] = $this->language->get('text_blog_list');
        $data['text_blog_setting'] = $this->language->get('text_blog_setting');
        $data['blog_list'] = $this->url->link( 'catalog/oct_blog', 'token=' . $this->session->data['token'], 'SSL' );
        $data['blog_setting'] = $this->url->link( 'catalog/oct_blog_setting', 'token=' . $this->session->data['token'], 'SSL' );
      

        $data['text_product_tabs'] = $this->language->get('text_product_tabs');
        $data['text_product_tabs_list'] = $this->language->get('text_product_tabs_list');
        $data['product_tabs_list'] = $this->url->link('catalog/product_tabs', 'token=' . $this->session->data['token'], 'SSL');
        $data['product_tabs_data'] = $this->config->get('product_tabs_data');
      

        $data['text_product_stickers'] = $this->language->get('text_product_stickers');
        $data['text_product_stickers_list'] = $this->language->get('text_product_stickers_list');
        $data['product_stickers_list'] = $this->url->link('catalog/product_stickers', 'token=' . $this->session->data['token'], 'SSL');
        $data['product_stickers_data'] = $this->config->get('product_stickers_data');
      

        $data['text_sstore'] = $this->language->get('text_sstore');
        $data['text_megamenu'] = $this->language->get('text_megamenu');
        $data['sstore_link'] = $this->url->link( 'module/storeset', 'token=' . $this->session->data['token'], 'SSL' );
        $data['megamenu_link'] = $this->url->link( 'module/megamenu', 'token=' . $this->session->data['token'], 'SSL' );
    ...
    // OCFilter start
		...
		$data['backup'] = $this->url->link('tool/backup', 'token=' . $this->session->data['token'], 'SSL');
				...
				$data['category_manager'] = $this->url->link('editors/category', 'token=' . $this->session->data['token'], 'SSL');
				$data['product_manager'] = $this->url->link('editors/product', 'token=' . $this->session->data['token'], 'SSL');
				$data['filter_manager'] = $this->url->link('editors/filter', 'token=' . $this->session->data['token'], 'SSL');
				$data['attribute_manager'] = $this->url->link('editors/attribute', 'token=' . $this->session->data['token'], 'SSL');
				$data['attribute_group_manager'] = $this->url->link('editors/attribute_group', 'token=' . $this->session->data['token'], 'SSL');
				$data['option_manager'] = $this->url->link('editors/option', 'token=' . $this->session->data['token'], 'SSL');
				$data['manufacturer_manager'] = $this->url->link('editors/manufacturer', 'token=' . $this->session->data['token'], 'SSL');
				$data['information_manager'] = $this->url->link('editors/information', 'token=' . $this->session->data['token'], 'SSL');
				$data['review_manager'] = $this->url->link('editors/review', 'token=' . $this->session->data['token'], 'SSL');
				$data['customer_manager'] = $this->url->link('editors/customer', 'token=' . $this->session->data['token'], 'SSL');
				$data['order_manager'] = $this->url->link('editors/order', 'token=' . $this->session->data['token'], 'SSL');
				$data['seo_manager'] = $this->url->link('tool/seo_manager', 'token=' . $this->session->data['token'], 'SSL');
				$data['setting_manager'] = $this->url->link('module/admin_quick_edit', 'token=' . $this->session->data['token'], 'SSL');
				if ($this->config->get('admin_quick_edit_activated') == 'activated') {
					$data['module_installed'] = $this->ModuleInstalled();
				} else {
					$data['module_installed'] = false;
				}
