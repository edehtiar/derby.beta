...
class ControllerCommonHeader extends Controller {
	public function index() {
        ...
        $popup_found_cheaper         = (array)$this->config->get('popup_found_cheaper_data');
        $data['popup_found_cheaper'] = (array)$this->config->get('popup_found_cheaper_data');
        ...
        // popup_found_cheaper start
        if (isset($popup_found_cheaper['status']) && $popup_found_cheaper['status']) {
          $data['text_popup_found_cheaper'] = $this->language->get('text_popup_found_cheaper');
          $data['text_total_popup_found_cheaper'] = $this->language->get('text_total_popup_found_cheaper');
          $data['popup_found_cheaper_url'] = $this->url->link('module/popup_found_cheaper', 'token=' . $this->session->data['token'], 'SSL');
          $data['total_popup_found_cheaper'] = $this->model_module_popup_found_cheaper->getTotalCallArray();
          $data['alerts'] = $data['alerts'] + $data['total_popup_found_cheaper'];
        }
        // popup_found_cheaper end
