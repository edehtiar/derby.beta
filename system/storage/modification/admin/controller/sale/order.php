...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			'bg_color' => $colors[$result['order_status_id']]['bg_color'],
			'txt_color' => $colors[$result['order_status_id']]['txt_color'],
				...
				'shipping_code' => $result['shipping_code'],
					...
					'novaposhta_ei_ref' => $result['novaposhta_ei_ref'],				    		
					'novaposhta_ei' => $this->url->link('shipping/novaposhta/getForm', 'token=' . $this->session->data['token'] . '&order_id=' . $result['order_id'] . $url, 'SSL'),
		...
		$data['button_ip_add'] = $this->language->get('button_ip_add');
					...
					$data['button_edit_ei'] = $this->language->get('button_edit_ei');
	...
	public function info() {
		...
		if ($order_info) {
			$this->load->language('sale/order');
					...
					$data['novaposhta_ei_ref'] = $order_info['novaposhta_ei_ref'];
    	
    				if (stristr($order_info['shipping_code'], '.', true) == 'novaposhta') {
				    	$data['button_ei'] = ($order_info['novaposhta_ei_ref']) ? $this->language->get('button_edit_ei') : $this->language->get('button_create_ei');
				    		
				    	$data['novaposhta_ei'] = $this->url->link('shipping/novaposhta/getForm', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');
    				}
