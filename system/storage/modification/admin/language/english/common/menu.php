<?php
        ...
        $_['text_oct_sreview'] = 'Octemplates - Store reviews';
        $_['text_oct_sreview_subject'] = 'Topics of the survey';
        $_['text_oct_sreview_reviews'] = 'Reviews List';
        $_['text_oct_sreview_setting'] = 'Reviews settings';
      

        $_['text_banner_plus'] = 'Octemplates Banner +';
      

        $_['text_blog'] = 'Blog';
        $_['text_blog_list'] = 'Blog List';
