...
class ModelCatalogProduct extends Model {
    ...
    $this->db->query("DELETE FROM " . DB_PREFIX . "ocfilter_option_value_to_product WHERE product_id = '" . (int)$product_id . "'");
        ...
        if (isset($images_by_options_data['status']) && $images_by_options_data['status']) {
          $this->db->query("DELETE FROM " . DB_PREFIX . "product_image_by_option WHERE product_id = '" . (int)$product_id . "'");
        }
        ...
        if (isset($images_by_options_data['status']) && $images_by_options_data['status']) {
          ...
          if (isset($product_image['image_by_option'])) {
            foreach ($product_image['image_by_option'] as $option_value_id) {
              $this->db->query("INSERT INTO " . DB_PREFIX . "product_image_by_option SET product_id = '" . (int)$product_id . "', product_image_id = '" . (int)$product_image_id . "', option_value_id = '" . (int)$option_value_id . "'");
            }
          }
        }
        // images_by_options end
        ...
        public function getProductOptionsToImage($product_id, $product_image_id) {
          $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_image_by_option WHERE product_id = '" . (int)$product_id . "' AND product_image_id = '" . (int)$product_image_id . "'");
