...
class ControllerCheckoutOctFastorder extends Controller { 
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/oct_fastorder/fastorder.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/checkout/oct_fastorder/fastorder.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/checkout/oct_fastorder/fastorder.tpl', $data));
		}
  }
  ...
  public function shipping_method($render = true, &$data = array()) {  	
		...
		if ($render !== false) {
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/oct_fastorder/shipping_method.tpl')) {
				$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/checkout/oct_fastorder/shipping_method.tpl', $data));
			} else {
				$this->response->setOutput($this->load->view('default/template/checkout/oct_fastorder/shipping_method.tpl', $data));
			}
		}
	}
	...
	public function payment_method($render = true, &$data = array()) {
		...
		if ($render !== false) {
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/oct_fastorder/payment_method.tpl')) {
				$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/checkout/oct_fastorder/payment_method.tpl', $data));
			} else {
				$this->response->setOutput($this->load->view('default/template/checkout/oct_fastorder/payment_method.tpl', $data));
			}
		}
	}
    ...
    $oct_fastorder_data = $this->config->get('oct_fastorder_data');
		...
		if (!$json) {
			...
			if (isset($this->request->post['telephone']) && ((utf8_strlen(str_replace(array('_','-','(',')','+'), "", $this->request->post['telephone'])) < 3 || utf8_strlen(str_replace(array('_','-','(',')','+'), "", $this->request->post['telephone'])) > 32))) {
  ...
  public function guest($render = false, &$data  = array()) {
    ...
    $data['checkout_buttons'] = array();
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/oct_fastorder/cart.tpl')) {
			...
			$this->response->setOutput($this->load->view('default/template/checkout/oct_fastorder/cart.tpl', $data));
		}
	}
