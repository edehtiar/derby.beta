...
<?php } else { ?>
                    ...
                    <div class="box-main">
                    	<div class="news-set center">
        					<h4 class="inner"><span><a href="<?php echo $setting['titlelink']; ?>"><?php echo $title; ?></a></span></h4>
						</div>
                         
                        <div class="category-slide">
                            <div id="cat-product<?php echo $setting['id']; ?>" class="owl-carousel owl-theme" style="display: block; opacity: 1;">
                        ...
                        <script>
                        $(document).ready(function() {
                          $('#cat-product<?php echo $setting['id']; ?>').owlCarousel({
                            loop:true,
