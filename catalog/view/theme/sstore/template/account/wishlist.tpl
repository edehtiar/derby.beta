      ...
      <table class="table table-hover">
        <thead>
          <tr class="wishlist-tr">
            ...
            <td class="text-left"><?php echo $column_stock; ?></td>
        ...
        <tbody>
          ...
          <tr class="wishlist-content-tr">
            ...
            <td class="text-left"><?php if ($product['price']) { ?>
              <div class="price">
              ...
              <?php } ?></td>
            <td class="text-left"><button type="button" onclick="addToCart('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i></button>
